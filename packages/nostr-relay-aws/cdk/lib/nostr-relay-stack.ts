...
`),
      ...
      const relayOriginPolicy = new cloudfront.OriginRequestPolicy(this, "RelayOriginPolicy", {
        originRequestPolicyName: "NostrRelayWebSocket",
        comment: "WebSocket + NIP-11: forward all headers except Host (API Gateway rejects custom Host)",
